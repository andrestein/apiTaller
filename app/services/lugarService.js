...
class CrudOperations {
    constructor() {
        ...
        this.baseFolder = config.scriptBasePathV1+"lugar/";
    }
    ...
    async getQueryTemplate(folder, fileSql, method) {
        ...
        // switch (method) {
        //     case "GET":
        //         fileTemplate += "get-{{fileSql}}.sql";
        //         break;
        //     case "POST":
        //         fileTemplate += "post-{{fileSql}}.sql";
        //         break;
        //     case "PUT":
        //         fileTemplate += "put-{{fileSql}}.sql";
        //         break;
        //     case "DELETE":
        //         fileTemplate += "del-{{fileSql}}.sql";
        //         break;
        //     default:
        //         fileTemplate += "{{fileSql}}.sql";
        //         break;
        // }
    ...
    async execute(sql) {
        ...
        return await this.client.query(sql) //tenía al principio "?"
                // : undefined;
    }
